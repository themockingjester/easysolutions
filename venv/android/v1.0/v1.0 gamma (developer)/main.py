"""
version: 1.0 (gamma - for Developer)
...
class uiApp(MDApp):
    try:
        ...
        internalstorage = "/home/themockingjester"
    def on_start(self):
    ...
    def build(self):
        ...
        try:
            os.mkdir((Environment.getExternalStorageDirectory().getAbsolutePath() + '/AcademicplusDownloads'))
        except:
            pass
        try:
        ...
        if os.path.exists(path_of_resources+"settings.txt"):
            ...
            try:
                storing_path = (Environment.getExternalStorageDirectory().getAbsolutePath() + '/AcademicplusDownloads')
            except:
                storing_path = "/home/themockingjester/AcademicplusDownloads"
    ...
    def download(self,instance):
        ...
        try:
            os.makedirs(
                Environment.getExternalStorageDirectory().getAbsolutePath() + '/AcademicplusDownloads/' + publisher + "/" + class_ + "/"+ bookname+"/" + lesson)
        except:
            pass

        path_on_local = (Environment.getExternalStorageDirectory().getAbsolutePath() + '/AcademicplusDownloads/' + publisher + "/" + class_ +"/"+ bookname+ "/" + lesson+"/")
        ...
        try:
            ...
            toast("Downloaded in phone AcademicplusDownloads folder")
        except:
